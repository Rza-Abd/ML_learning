...
neurak_network = NeuralNetwork(learning_rate)

prediction = neurak_network.predict(input_vector)

print(f"Weight = {neurak_network.weights}, bias = {neurak_network.bias}")
